...
**earliest_date** | [**\DateTime**](\DateTime.md) | Write only! | [optional] 
**latest_date** | [**\DateTime**](\DateTime.md) | Write only! | [optional] 
...
**executed_activity_duration** | **int** | Executed duration for all activities in this route in minutes | [optional] 
**executed_start_duration** | **string** | Duration for start activity | [optional] 
**executed_driving_duration** | **int** | Executed driving time of this route in minutes | [optional] 
**executed_waiting_duration** | **int** | Executed waiting time of this route in minutes | [optional] 
**executed_end_duration** | **string** | Executed duration for end activity | [optional] 
