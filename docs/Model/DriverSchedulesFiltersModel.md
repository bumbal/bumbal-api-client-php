...
**date** | [**\DateTime**](Date.md) | Drivers&#39; schedule date, in the format YYYY-MM-DD | [optional] 
**date_range** | [**\DateTime[]**](Date.md) | Drivers&#39; schedule date range, as an array of two dates, in the format YYYY-MM-DD | [optional] 
