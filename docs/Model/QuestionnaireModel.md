...
**required** | **bool** | wether the questionnaire is required to be filled in | [optional] 
**dynamic** | **bool** | wether the questionnaire is dynamic (non-liniar flow for the questions, where the answer to one question could impact the choice of the follow-up question. | [optional] 
**finished** | **bool** | wether the questionnaire is already filled in completely | [optional] 
