...
**shipment_inbound_activity_ids** | **int[]** | Unique identifiers for connected shipment inbound activities | [optional] 
**shipment_outbound_activity_ids** | **int[]** | Unique identifiers for connected shipment outbound activities | [optional] 
...
**earliest_delivery_date_time** | [**\DateTime**](\DateTime.md) |  | [optional] 
**latest_delivery_date_time** | [**\DateTime**](\DateTime.md) |  | [optional] 
...
**executed_duration** | **int** | Executed duration of this activity in minutes | [optional] 
**executed_driving_duration** | **int** | Executed driving duration of this activity in minutes | [optional] 
...
**shipment_inbound_shipment_address_ids** | **int[]** | Unique identifiers for connected shipment inbound addresses | [optional] 
**shipment_outbound_shipment_address_ids** | **int[]** | Unique identifiers for connected shipment outbound addresses | [optional] 
**depot_activity** | [**\BumbalClient\Model\ActivityModel**](ActivityModel.md) |  | [optional] 
**depot_activities** | [**\BumbalClient\Model\ActivityModel[]**](ActivityModel.md) |  | [optional] 
