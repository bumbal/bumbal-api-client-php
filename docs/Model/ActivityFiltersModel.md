...
**earliest_delivery_date_since** | [**\DateTime**](\DateTime.md) | Show activities with a earliest_delivery_date younger than filter value | [optional] 
**earliest_delivery_date_till** | [**\DateTime**](\DateTime.md) | Show activities with a earliest_delivery_date older than filter value | [optional] 
**latest_delivery_date_since** | [**\DateTime**](\DateTime.md) | Show activities with a latest_delivery_date younger than filter value | [optional] 
**latest_delivery_date_till** | [**\DateTime**](\DateTime.md) | Show activities with a latest_delivery_date older than filter value | [optional] 
