...
$apiInstance = new BumbalClient\Api\QuestionnaireTemplateQuestionApi(
...
try {
    $result = $apiInstance->createQuestionnaireTemplateQuestion($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->deleteQuestionnaireTemplateQuestion($questionnaire_template_question_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListQuestionnaireTemplateQuestion($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveQuestionnaireTemplateQuestion($questionnaire_template_question_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setQuestionnaireTemplateQuestion($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateQuestionnaireTemplateQuestion($questionnaire_template_question_id, $body);
    print_r($result);
} catch (Exception $e) {
