...
$apiInstance = new BumbalClient\Api\QuestionnaireTemplateQuestionOptionApi(
...
try {
    $result = $apiInstance->createQuestionnaireTemplateQuestionOption($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->deleteQuestionnaireTemplateQuestionOption($questionnaire_template_question_option_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->findPossibleFollowUpQuestions($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->getPossibleFollowUpQuestions($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListQuestionnaireTemplateQuestionOption($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveQuestionnaireTemplateQuestionOption($questionnaire_template_question_option_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setQuestionnaireTemplateQuestionOption($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateQuestionnaireTemplateQuestionOption($questionnaire_template_question_option_id, $body);
    print_r($result);
} catch (Exception $e) {
