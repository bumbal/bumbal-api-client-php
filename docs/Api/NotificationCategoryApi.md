...
$apiInstance = new BumbalClient\Api\NotificationCategoryApi(
...
try {
    $result = $apiInstance->createNotificationCategory($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->deleteNotificationCategory($notification_category_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListNotificationCategory($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveNotificationCategory($notification_category_id, $include_object_type_name, $include_record_info);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setNotificationCategory($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateNotificationCategory($notification_category_id, $body);
    print_r($result);
} catch (Exception $e) {
