...
$apiInstance = new BumbalClient\Api\CommunicationMessageTypeApi(
...
try {
    $result = $apiInstance->listCommunicationMessageTypes($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveCommunicationMessageType($communication_message_type_id);
    print_r($result);
} catch (Exception $e) {
