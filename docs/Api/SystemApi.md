...
[**systemGetOptions**](SystemApi.md#systemGetOptions) | **GET** /system/options | Retrieve System Options
...
# **systemGetOptions**
> map[string,bool] systemGetOptions()
...
try {
    $result = $api_instance->systemGetOptions();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SystemApi->systemGetOptions: ', $e->getMessage(), PHP_EOL;
}
?>
```
