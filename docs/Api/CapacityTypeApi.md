...
$apiInstance = new BumbalClient\Api\CapacityTypeApi(
...
try {
    $result = $apiInstance->deleteCapacityType($capacity_type_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveCapacityType($capacity_type_id, $include_uom, $include_uom_group, $include_uom_name);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListCapacityType($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setCapacityType($body);
    print_r($result);
} catch (Exception $e) {
