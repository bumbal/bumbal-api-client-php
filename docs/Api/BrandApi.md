...
$apiInstance = new BumbalClient\Api\BrandApi(
...
try {
    $result = $apiInstance->retrieveBrand($brand_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListBrand($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setBrand($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateBrand($brand_id);
    print_r($result);
} catch (Exception $e) {
