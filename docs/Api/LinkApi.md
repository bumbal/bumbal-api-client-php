...
$apiInstance = new BumbalClient\Api\LinkApi(
...
try {
    $result = $apiInstance->deleteLink($link_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListLink($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateLink($link_id, $body);
    print_r($result);
} catch (Exception $e) {
