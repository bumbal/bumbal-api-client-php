...
[**triggerMessageCommunicationByMessageType**](CommunicationApi.md#triggerMessageCommunicationByMessageType) | **POST** /communication/trigger-message-by-message-type | Trigger Message to Communication by Message Type
...
try {
    ...
    echo 'Exception when calling CommunicationApi->triggerMessageCommunicationByMessageType: ', $e->getMessage(), PHP_EOL;
}
?>
```
