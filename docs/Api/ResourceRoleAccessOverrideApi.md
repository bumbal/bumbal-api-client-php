...
$apiInstance = new BumbalClient\Api\ResourceRoleAccessOverrideApi(
...
try {
    $result = $apiInstance->createResourceRoleAccessOverride($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->deleteResourceRoleAccessOverride($resource_role_access_override_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListResourceRoleAccessOverride($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveResourceRoleAccessOverrideId($resource_role_access_override_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setResourceRoleAccessOverride($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateResourceRoleAccessOverride($resource_role_access_override_id);
    print_r($result);
} catch (Exception $e) {
