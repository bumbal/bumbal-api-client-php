...
$apiInstance = new BumbalClient\Api\PortalSettingApi(
...
try {
    $result = $apiInstance->retrieveListPortalSetting($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrievePortalSetting($portal_setting_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->setPortalSetting($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updatePortalSetting($portal_setting_id);
    print_r($result);
} catch (Exception $e) {
