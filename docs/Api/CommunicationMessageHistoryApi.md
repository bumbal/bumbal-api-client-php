...
$apiInstance = new BumbalClient\Api\CommunicationMessageHistoryApi(
...
try {
    $result = $apiInstance->createCommunicationMessageHistory($body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveListCommunicationMessageHistories($arguments);
    print_r($result);
} catch (Exception $e) {
