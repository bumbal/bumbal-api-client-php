...
$apiInstance = new BumbalClient\Api\SystemProviderApi(
...
try {
    $result = $apiInstance->retrieveListSystemProvider($arguments);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveSystemProvider($provider_id);
    print_r($result);
} catch (Exception $e) {
