...
class ActivityApi
{
    ...
    public function duplicateActivitiesWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling duplicateActivities');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\BumbalClient\Model\DuplicateJobAcceptedResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BumbalClient\Model\DuplicateJobAcceptedResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function getActivityDuplicateStatusWithHttpInfo($token)
    {
        ...
        if ($token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $token when calling getActivityDuplicateStatus');
        }
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/activity/duplicate/status/{token}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\BumbalClient\Model\DuplicateStatusResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function lockActivityOnRouteWithHttpInfo($filters)
    {
        // verify the required parameter 'filters' is set
        if ($filters === null) {
            throw new \InvalidArgumentException('Missing the required parameter $filters when calling lockActivityOnRoute');
        }
        // parse inputs
    ...
    public function lockActivityOnRouteAndTimeWithHttpInfo($filters)
    {
        // verify the required parameter 'filters' is set
        if ($filters === null) {
            throw new \InvalidArgumentException('Missing the required parameter $filters when calling lockActivityOnRouteAndTime');
        }
        // parse inputs
