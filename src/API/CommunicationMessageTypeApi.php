...
class CommunicationMessageTypeApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageTypeListResponse';
        $request = $this->listCommunicationMessageTypesRequest($arguments);
    ...
    /**
     * Operation listCommunicationMessageTypesAsync
     *
     * List all CommunicationMessageTypes
     *
     * @param  \BumbalClient\Model\CommunicationMessageTypeRetrieveListArguments $arguments Communication Message Type RetrieveList Arguments (required)
     ...
     */
    public function listCommunicationMessageTypesAsync($arguments)
    {
        return $this->listCommunicationMessageTypesAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listCommunicationMessageTypesAsyncWithHttpInfo
     *
     * List all CommunicationMessageTypes
     *
     * @param  \BumbalClient\Model\CommunicationMessageTypeRetrieveListArguments $arguments Communication Message Type RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCommunicationMessageTypesAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageTypeListResponse';
        $request = $this->listCommunicationMessageTypesRequest($arguments);
    ...
    /**
     * Create request for operation 'listCommunicationMessageTypes'
     *
     * @param  \BumbalClient\Model\CommunicationMessageTypeRetrieveListArguments $arguments Communication Message Type RetrieveList Arguments (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function listCommunicationMessageTypesRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling listCommunicationMessageTypes'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageTypeModel';
        $request = $this->retrieveCommunicationMessageTypeRequest($communication_message_type_id);
    ...
    /**
     * Operation retrieveCommunicationMessageTypeAsync
     *
     * Retrieve a communication message type
     *
     * @param  int $communication_message_type_id ID of communication message type to return (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveCommunicationMessageTypeAsync($communication_message_type_id)
    {
        return $this->retrieveCommunicationMessageTypeAsyncWithHttpInfo($communication_message_type_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveCommunicationMessageTypeAsyncWithHttpInfo
     *
     * Retrieve a communication message type
     *
     * @param  int $communication_message_type_id ID of communication message type to return (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveCommunicationMessageTypeAsyncWithHttpInfo($communication_message_type_id)
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageTypeModel';
        $request = $this->retrieveCommunicationMessageTypeRequest($communication_message_type_id);
    ...
    /**
     * Create request for operation 'retrieveCommunicationMessageType'
     *
     * @param  int $communication_message_type_id ID of communication message type to return (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveCommunicationMessageTypeRequest($communication_message_type_id)
    {
        // verify the required parameter 'communication_message_type_id' is set
        if ($communication_message_type_id === null || (is_array($communication_message_type_id) && count($communication_message_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $communication_message_type_id when calling retrieveCommunicationMessageType'
            );
        }
        ...
        if ($communication_message_type_id !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($communication_message_type_id),
                $resourcePath
            );
        }
