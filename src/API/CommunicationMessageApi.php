...
class CommunicationMessageApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageModel';
        $request = $this->retrieveCommunicationMessageRequest($communication_message_id);
    ...
    /**
     * Operation retrieveCommunicationMessageAsync
     *
     * Retrieve a communication message
     *
     * @param  int $communication_message_id ID of template to return (required)
     ...
     */
    public function retrieveCommunicationMessageAsync($communication_message_id)
    {
        return $this->retrieveCommunicationMessageAsyncWithHttpInfo($communication_message_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveCommunicationMessageAsyncWithHttpInfo
     *
     * Retrieve a communication message
     *
     * @param  int $communication_message_id ID of template to return (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveCommunicationMessageAsyncWithHttpInfo($communication_message_id)
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageModel';
        $request = $this->retrieveCommunicationMessageRequest($communication_message_id);
    ...
    /**
     * Create request for operation 'retrieveCommunicationMessage'
     *
     * @param  int $communication_message_id ID of template to return (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function retrieveCommunicationMessageRequest($communication_message_id)
    {
        // verify the required parameter 'communication_message_id' is set
        if ($communication_message_id === null || (is_array($communication_message_id) && count($communication_message_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $communication_message_id when calling retrieveCommunicationMessage'
            );
        }
        ...
        if ($communication_message_id !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($communication_message_id),
                $resourcePath
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageListResponse';
        $request = $this->retrieveListCommunicationMessagesRequest($arguments);
    ...
    /**
     * Operation retrieveListCommunicationMessagesAsync
     *
     * Retrieve List of communication messages
     *
     * @param  \BumbalClient\Model\CommunicationMessageRetrieveListArguments $arguments Template RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListCommunicationMessagesAsync($arguments)
    {
        return $this->retrieveListCommunicationMessagesAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveListCommunicationMessagesAsyncWithHttpInfo
     *
     * Retrieve List of communication messages
     *
     * @param  \BumbalClient\Model\CommunicationMessageRetrieveListArguments $arguments Template RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListCommunicationMessagesAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\CommunicationMessageListResponse';
        $request = $this->retrieveListCommunicationMessagesRequest($arguments);
    ...
    /**
     * Create request for operation 'retrieveListCommunicationMessages'
     *
     * @param  \BumbalClient\Model\CommunicationMessageRetrieveListArguments $arguments Template RetrieveList Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveListCommunicationMessagesRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling retrieveListCommunicationMessages'
            );
        }
