...
class DriverApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\DriverModel';
    ...
    protected function retrieveDriverRequest($driver_id, $include_driver_tags, $include_updated_by)
    {
        ...
        if ($include_driver_tags === null || (is_array($include_driver_tags) && count($include_driver_tags) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        $returnType = '\BumbalClient\Model\DriverListResponse';
