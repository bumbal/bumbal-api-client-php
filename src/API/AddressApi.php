...
class AddressApi
{
    ...
    public function geoCodeAddressWithHttpInfo($arguments)
    {
        ...
        if ($arguments === null) {
            throw new \InvalidArgumentException('Missing the required parameter $arguments when calling geoCodeAddress');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\BumbalClient\Model\AddressGeoCodeResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function suggestAddressWithHttpInfo($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null) {
            throw new \InvalidArgumentException('Missing the required parameter $arguments when calling suggestAddress');
        }
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\BumbalClient\Model\AddressSuggestionResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BumbalClient\Model\AddressSuggestionResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
