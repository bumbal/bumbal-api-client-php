...
class PortalApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\PortalListResponse';
        $request = $this->retrieveListPortalRequest($arguments);
    ...
    /**
     * Operation retrieveListPortalAsync
     *
     * Retrieve List of Portals
     *
     * @param  \BumbalClient\Model\PortalRetrieveListArguments $arguments Portal RetrieveList Arguments (required)
     ...
     */
    public function retrieveListPortalAsync($arguments)
    {
        return $this->retrieveListPortalAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveListPortalAsyncWithHttpInfo
     *
     * Retrieve List of Portals
     *
     * @param  \BumbalClient\Model\PortalRetrieveListArguments $arguments Portal RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListPortalAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\PortalListResponse';
        $request = $this->retrieveListPortalRequest($arguments);
    ...
    /**
     * Create request for operation 'retrieveListPortal'
     *
     * @param  \BumbalClient\Model\PortalRetrieveListArguments $arguments Portal RetrieveList Arguments (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function retrieveListPortalRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling retrieveListPortal'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\PortalModel';
        $request = $this->retrievePortalRequest($portal_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePortalAsync($portal_id)
    {
        return $this->retrievePortalAsyncWithHttpInfo($portal_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrievePortalAsyncWithHttpInfo
     *
     * Retrieve a Portal
     *
     * @param  int $portal_id ID of portal to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePortalAsyncWithHttpInfo($portal_id)
    {
        $returnType = '\BumbalClient\Model\PortalModel';
        $request = $this->retrievePortalRequest($portal_id);
    ...
    /**
     * Create request for operation 'retrievePortal'
     *
     * @param  int $portal_id ID of portal to retrieve (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrievePortalRequest($portal_id)
    {
        // verify the required parameter 'portal_id' is set
        if ($portal_id === null || (is_array($portal_id) && count($portal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $portal_id when calling retrievePortal'
            );
        }
    ...
    public function setPortalWithHttpInfo($body = null)
    {
        ...
        $request = $this->setPortalRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setPortalAsync($body = null)
    {
        return $this->setPortalAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setPortalAsyncWithHttpInfo
     *
     * Set (create or update) a Portal
     *
     * @param  \BumbalClient\Model\PortalModel $body Portal object (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setPortalAsyncWithHttpInfo($body = null)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->setPortalRequest($body);
    ...
    /**
     * Create request for operation 'setPortal'
     *
     * @param  \BumbalClient\Model\PortalModel $body Portal object (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setPortalRequest($body = null)
    {
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->updatePortalRequest($portal_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePortalAsync($portal_id)
    {
        return $this->updatePortalAsyncWithHttpInfo($portal_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updatePortalAsyncWithHttpInfo
     *
     * Update a Portal
     *
     * @param  int $portal_id ID of portal to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePortalAsyncWithHttpInfo($portal_id)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->updatePortalRequest($portal_id);
    ...
    /**
     * Create request for operation 'updatePortal'
     *
     * @param  int $portal_id ID of portal to update (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePortalRequest($portal_id)
    {
        // verify the required parameter 'portal_id' is set
        if ($portal_id === null || (is_array($portal_id) && count($portal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $portal_id when calling updatePortal'
            );
        }
