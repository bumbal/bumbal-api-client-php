...
class ProviderApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse22';
        $request = $this->createProviderRequest($body);
     ...
     */
    public function createProviderAsync($body = null)
    {
        return $this->createProviderAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createProviderAsyncWithHttpInfo
     *
     * Add a new Provider
     *
     * @param  \BumbalClient\Model\ProviderModel $body Provider object that needs to be created (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProviderAsyncWithHttpInfo($body = null)
    {
        $returnType = '\BumbalClient\Model\ApiResponse22';
        $request = $this->createProviderRequest($body);
    ...
    /**
     * Create request for operation 'createProvider'
     *
     * @param  \BumbalClient\Model\ProviderModel $body Provider object that needs to be created (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function createProviderRequest($body = null)
    {
    ...
    {
        $returnType = '\BumbalClient\Model\ProviderListResponse';
        $request = $this->retrieveListProviderRequest($arguments);
    ...
    /**
     * Operation retrieveListProviderAsync
     *
     * Retrieve List of Providers
     *
     * @param  \BumbalClient\Model\ProviderRetrieveListArguments $arguments Provider RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListProviderAsync($arguments)
    {
        return $this->retrieveListProviderAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveListProviderAsyncWithHttpInfo
     *
     * Retrieve List of Providers
     *
     * @param  \BumbalClient\Model\ProviderRetrieveListArguments $arguments Provider RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListProviderAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\ProviderListResponse';
        $request = $this->retrieveListProviderRequest($arguments);
    ...
    /**
     * Create request for operation 'retrieveListProvider'
     *
     * @param  \BumbalClient\Model\ProviderRetrieveListArguments $arguments Provider RetrieveList Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveListProviderRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling retrieveListProvider'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\ProviderModel';
        $request = $this->retrieveProviderRequest($provider_id);
    ...
    /**
     * Operation retrieveProviderAsync
     *
     * Retrieve a Provider
     *
     * @param  int $provider_id ID of provider to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProviderAsync($provider_id)
    {
        return $this->retrieveProviderAsyncWithHttpInfo($provider_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveProviderAsyncWithHttpInfo
     *
     * Retrieve a Provider
     *
     * @param  int $provider_id ID of provider to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveProviderAsyncWithHttpInfo($provider_id)
    {
        $returnType = '\BumbalClient\Model\ProviderModel';
        $request = $this->retrieveProviderRequest($provider_id);
    ...
    /**
     * Create request for operation 'retrieveProvider'
     *
     * @param  int $provider_id ID of provider to retrieve (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveProviderRequest($provider_id)
    {
        // verify the required parameter 'provider_id' is set
        if ($provider_id === null || (is_array($provider_id) && count($provider_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $provider_id when calling retrieveProvider'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse21';
        $request = $this->updateProviderRequest($provider_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProviderAsync($provider_id, $body = null)
    {
        return $this->updateProviderAsyncWithHttpInfo($provider_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProviderAsyncWithHttpInfo($provider_id, $body = null)
    {
        $returnType = '\BumbalClient\Model\ApiResponse21';
        $request = $this->updateProviderRequest($provider_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProviderRequest($provider_id, $body = null)
    {
        // verify the required parameter 'provider_id' is set
        if ($provider_id === null || (is_array($provider_id) && count($provider_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $provider_id when calling updateProvider'
            );
        }
