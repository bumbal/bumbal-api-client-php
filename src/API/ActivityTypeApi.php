...
class ActivityTypeApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\ActivityTypeModel';
        $request = $this->retrieveActivityTypeRequest($activity_type_id);
    ...
    /**
     * Operation retrieveActivityTypeAsync
     *
     * Find ActivityType by ID
     *
     * @param  int $activity_type_id ID of ActivityType to return (required)
     ...
     */
    public function retrieveActivityTypeAsync($activity_type_id)
    {
        return $this->retrieveActivityTypeAsyncWithHttpInfo($activity_type_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveActivityTypeAsyncWithHttpInfo
     *
     * Find ActivityType by ID
     *
     * @param  int $activity_type_id ID of ActivityType to return (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveActivityTypeAsyncWithHttpInfo($activity_type_id)
    {
        $returnType = '\BumbalClient\Model\ActivityTypeModel';
        $request = $this->retrieveActivityTypeRequest($activity_type_id);
    ...
    /**
     * Create request for operation 'retrieveActivityType'
     *
     * @param  int $activity_type_id ID of ActivityType to return (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function retrieveActivityTypeRequest($activity_type_id)
    {
        ...
        if ($activity_type_id === null || (is_array($activity_type_id) && count($activity_type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $activity_type_id when calling retrieveActivityType'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\ActivityTypeListResponse';
        $request = $this->retrieveListActivityTypeRequest($arguments);
    ...
    /**
     * Operation retrieveListActivityTypeAsync
     *
     * Retrieve List of ActivityTypes
     *
     * @param  \BumbalClient\Model\ActivityTypeRetrieveListArguments $arguments ActivityType RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListActivityTypeAsync($arguments)
    {
        return $this->retrieveListActivityTypeAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveListActivityTypeAsyncWithHttpInfo
     *
     * Retrieve List of ActivityTypes
     *
     * @param  \BumbalClient\Model\ActivityTypeRetrieveListArguments $arguments ActivityType RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListActivityTypeAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\ActivityTypeListResponse';
        $request = $this->retrieveListActivityTypeRequest($arguments);
    ...
    /**
     * Create request for operation 'retrieveListActivityType'
     *
     * @param  \BumbalClient\Model\ActivityTypeRetrieveListArguments $arguments ActivityType RetrieveList Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveListActivityTypeRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling retrieveListActivityType'
            );
        }
