...
class SystemApi
{
    ...
    public function systemGetOptionsWithHttpInfo()
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, 'map[string,bool]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), 'map[string,bool]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function systemSetConfigWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling systemSetConfig');
        }
        // parse inputs
