...
class LinkApi
{
    ...
    public function deleteLinkWithHttpInfo($link_id)
    {
        ...
        $request = $this->deleteLinkRequest($link_id);
     ...
     */
    public function deleteLinkAsync($link_id)
    {
        return $this->deleteLinkAsyncWithHttpInfo($link_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLinkAsyncWithHttpInfo($link_id)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->deleteLinkRequest($link_id);
     ...
     */
    protected function deleteLinkRequest($link_id)
    {
    ...
    {
        $returnType = '\BumbalClient\Model\LinkListResponse[]';
        $request = $this->retrieveListLinkRequest($arguments);
    ...
    /**
     * Operation retrieveListLinkAsync
     *
     * Retrieve List of Links
     *
     * @param  \BumbalClient\Model\LinkRetrieveListArguments $arguments Link RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListLinkAsync($arguments)
    {
        return $this->retrieveListLinkAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveListLinkAsyncWithHttpInfo
     *
     * Retrieve List of Links
     *
     * @param  \BumbalClient\Model\LinkRetrieveListArguments $arguments Link RetrieveList Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveListLinkAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\LinkListResponse[]';
        $request = $this->retrieveListLinkRequest($arguments);
    ...
    /**
     * Create request for operation 'retrieveListLink'
     *
     * @param  \BumbalClient\Model\LinkRetrieveListArguments $arguments Link RetrieveList Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveListLinkRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling retrieveListLink'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->updateLinkRequest($link_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLinkAsync($link_id, $body = null)
    {
        return $this->updateLinkAsyncWithHttpInfo($link_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLinkAsyncWithHttpInfo($link_id, $body = null)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->updateLinkRequest($link_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateLinkRequest($link_id, $body = null)
    {
        // verify the required parameter 'link_id' is set
        if ($link_id === null || (is_array($link_id) && count($link_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $link_id when calling updateLink'
            );
        }
