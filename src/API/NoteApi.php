...
class NoteApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\NoteModel[]';
    ...
    protected function retrieveNoteRequest($note_id, $include_note_tags, $include_note_tag_type_link_ids, $include_note_object_link_ids, $include_updated_by)
    {
        ...
        if ($include_note_tags === null || (is_array($include_note_tags) && count($include_note_tags) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_note_tag_type_link_ids === null || (is_array($include_note_tag_type_link_ids) && count($include_note_tag_type_link_ids) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_note_object_link_ids === null || (is_array($include_note_object_link_ids) && count($include_note_object_link_ids) === 0)) {
            throw new \InvalidArgumentException(
