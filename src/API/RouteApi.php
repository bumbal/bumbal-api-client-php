...
class RouteApi
{
    ...
    public function blockRoutesWithHttpInfo($filters)
    {
        ...
        if ($filters === null) {
            throw new \InvalidArgumentException('Missing the required parameter $filters when calling blockRoutes');
        }
        // parse inputs
    ...
    public function duplicateRoutesWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling duplicateRoutes');
        }
        // parse inputs
    ...
    public function getRouteDuplicateStatusWithHttpInfo($token)
    {
        ...
        if ($token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $token when calling getRouteDuplicateStatus');
        }
        // parse inputs
    ...
    public function unblockRoutesWithHttpInfo($filters)
    {
        // verify the required parameter 'filters' is set
        if ($filters === null) {
            throw new \InvalidArgumentException('Missing the required parameter $filters when calling unblockRoutes');
        }
        // parse inputs
