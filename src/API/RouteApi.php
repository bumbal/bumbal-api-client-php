...
class RouteApi
{
    ...
    /**
     * Operation blockRoutes
     *
     * Block routes which satisfy set filters
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     *
     * @throws \BumbalClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BumbalClient\Model\ApiResponse
     */
    public function blockRoutes($filters)
    {
        list($response) = $this->blockRoutesWithHttpInfo($filters);
        return $response;
    }

    /**
     * Operation blockRoutesWithHttpInfo
     *
     * Block routes which satisfy set filters
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     ...
     */
    public function blockRoutesWithHttpInfo($filters)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->blockRoutesRequest($filters);
     ...
     */
    public function blockRoutesAsync($filters)
    {
        return $this->blockRoutesAsyncWithHttpInfo($filters)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blockRoutesAsyncWithHttpInfo
     *
     * Block routes which satisfy set filters
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blockRoutesAsyncWithHttpInfo($filters)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->blockRoutesRequest($filters);
    ...
    /**
     * Create request for operation 'blockRoutes'
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function blockRoutesRequest($filters)
    {
        // verify the required parameter 'filters' is set
        if ($filters === null || (is_array($filters) && count($filters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $filters when calling blockRoutes'
            );
        }

        $resourcePath = '/route/block-routes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteRouteRequest($route_id, $cancel_activities)
    {
        ...
        if ($cancel_activities === null || (is_array($cancel_activities) && count($cancel_activities) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \BumbalClient\Model\RouteDetachFromRecurrenceArguments $body Detach from Recurrence Arguments (optional)
     *
     * @throws \BumbalClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BumbalClient\Model\ApiResponse
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->detachRoutesFromRecurrenceRequest($body);
    ...
    /**
     * Operation detachRoutesFromRecurrenceAsync
     *
     * detach routes from specified recurrence
     *
     * @param  \BumbalClient\Model\RouteDetachFromRecurrenceArguments $body Detach from Recurrence Arguments (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachRoutesFromRecurrenceAsync($body = null)
    {
        return $this->detachRoutesFromRecurrenceAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation detachRoutesFromRecurrenceAsyncWithHttpInfo
     *
     * detach routes from specified recurrence
     *
     * @param  \BumbalClient\Model\RouteDetachFromRecurrenceArguments $body Detach from Recurrence Arguments (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detachRoutesFromRecurrenceAsyncWithHttpInfo($body = null)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->detachRoutesFromRecurrenceRequest($body);
    ...
    /**
     * Create request for operation 'detachRoutesFromRecurrence'
     *
     * @param  \BumbalClient\Model\RouteDetachFromRecurrenceArguments $body Detach from Recurrence Arguments (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function detachRoutesFromRecurrenceRequest($body = null)
    {
    ...
    /**
     * Operation duplicateRoutes
     *
     * Bulk duplicate routes
     *
     * @param  \BumbalClient\Model\RouteDuplicateArgumentsModel $body body (required)
     *
     * @throws \BumbalClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BumbalClient\Model\DuplicateJobAcceptedResponse
     */
    public function duplicateRoutes($body)
    {
        list($response) = $this->duplicateRoutesWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation duplicateRoutesWithHttpInfo
     *
     * Bulk duplicate routes
     *
     * @param  \BumbalClient\Model\RouteDuplicateArgumentsModel $body (required)
     *
     * @throws \BumbalClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BumbalClient\Model\DuplicateJobAcceptedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function duplicateRoutesWithHttpInfo($body)
    {
        $returnType = '\BumbalClient\Model\DuplicateJobAcceptedResponse';
        $request = $this->duplicateRoutesRequest($body);
    ...
    /**
     * Operation duplicateRoutesAsync
     *
     * Bulk duplicate routes
     *
     * @param  \BumbalClient\Model\RouteDuplicateArgumentsModel $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function duplicateRoutesAsync($body)
    {
        return $this->duplicateRoutesAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation duplicateRoutesAsyncWithHttpInfo
     *
     * Bulk duplicate routes
     *
     * @param  \BumbalClient\Model\RouteDuplicateArgumentsModel $body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function duplicateRoutesAsyncWithHttpInfo($body)
    {
        $returnType = '\BumbalClient\Model\DuplicateJobAcceptedResponse';
        $request = $this->duplicateRoutesRequest($body);
    ...
    /**
     * Create request for operation 'duplicateRoutes'
     *
     * @param  \BumbalClient\Model\RouteDuplicateArgumentsModel $body (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function duplicateRoutesRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling duplicateRoutes'
            );
        }

        $resourcePath = '/route/duplicate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->getExecutableActivitiesRequest($arguments);
    ...
    /**
     * Operation getExecutableActivitiesAsync
     *
     * Returns all activities in this route which hav enot been executed yet.
     *
     * @param  \BumbalClient\Model\GetExecutableActivitiesArguments $arguments Request Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExecutableActivitiesAsync($arguments)
    {
        return $this->getExecutableActivitiesAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExecutableActivitiesAsyncWithHttpInfo
     *
     * Returns all activities in this route which hav enot been executed yet.
     *
     * @param  \BumbalClient\Model\GetExecutableActivitiesArguments $arguments Request Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExecutableActivitiesAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->getExecutableActivitiesRequest($arguments);
    ...
    /**
     * Create request for operation 'getExecutableActivities'
     *
     * @param  \BumbalClient\Model\GetExecutableActivitiesArguments $arguments Request Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExecutableActivitiesRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling getExecutableActivities'
            );
        }
    ...
    /**
     * Operation getRouteDuplicateStatus
     *
     ...
     */
    public function getRouteDuplicateStatus($token)
    {
        list($response) = $this->getRouteDuplicateStatusWithHttpInfo($token);
        return $response;
    }

    /**
     * Operation getRouteDuplicateStatusWithHttpInfo
     *
     * Check route duplication job status
     *
     * @param  string $token Token returned when the duplicate job was created (required)
     ...
     */
    public function getRouteDuplicateStatusWithHttpInfo($token)
    {
        $returnType = '\BumbalClient\Model\DuplicateStatusResponse';
        $request = $this->getRouteDuplicateStatusRequest($token);
    ...
    /**
     * Operation getRouteDuplicateStatusAsync
     *
     * Check route duplication job status
     *
     * @param  string $token Token returned when the duplicate job was created (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRouteDuplicateStatusAsync($token)
    {
        return $this->getRouteDuplicateStatusAsyncWithHttpInfo($token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRouteDuplicateStatusAsyncWithHttpInfo
     *
     * Check route duplication job status
     *
     * @param  string $token Token returned when the duplicate job was created (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRouteDuplicateStatusAsyncWithHttpInfo($token)
    {
        $returnType = '\BumbalClient\Model\DuplicateStatusResponse';
        $request = $this->getRouteDuplicateStatusRequest($token);
    ...
    /**
     * Create request for operation 'getRouteDuplicateStatus'
     *
     * @param  string $token Token returned when the duplicate job was created (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRouteDuplicateStatusRequest($token)
    {
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling getRouteDuplicateStatus'
            );
        }

        $resourcePath = '/route/duplicate/status/{token}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        $returnType = '\BumbalClient\Model\RouteListResponse';
    ...
    public function retrieveRouteWithHttpInfo($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling = null)
    {
        ...
        $request = $this->retrieveRouteRequest($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRouteAsync($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling = null)
    {
        return $this->retrieveRouteAsyncWithHttpInfo($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRouteAsyncWithHttpInfo($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling = null)
    {
        $returnType = '\BumbalClient\Model\RouteModel';
        $request = $this->retrieveRouteRequest($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveRouteRequest($route_id, $include_address_object, $include_route_status, $include_route_tags, $include_driver_info, $include_equipment_info_car, $include_gps_locations, $include_corrected_gps_locations, $include_activity_ids, $include_latest_position, $apply_address_bundling = null)
    {
        // verify the required parameter 'route_id' is set
        if ($route_id === null || (is_array($route_id) && count($route_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_route_status === null || (is_array($include_route_status) && count($include_route_status) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_route_tags === null || (is_array($include_route_tags) && count($include_route_tags) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_equipment_info_car === null || (is_array($include_equipment_info_car) && count($include_equipment_info_car) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_gps_locations === null || (is_array($include_gps_locations) && count($include_gps_locations) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_corrected_gps_locations === null || (is_array($include_corrected_gps_locations) && count($include_corrected_gps_locations) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $include_corrected_gps_locations when calling retrieveRoute'
            );
        }
        // verify the required parameter 'include_activity_ids' is set
        if ($include_activity_ids === null || (is_array($include_activity_ids) && count($include_activity_ids) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_latest_position === null || (is_array($include_latest_position) && count($include_latest_position) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($include_corrected_gps_locations !== null) {
            $queryParams['include_corrected_gps_locations'] = ObjectSerializer::toQueryValue($include_corrected_gps_locations);
        }
        // query params
    ...
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->routeStoreGeoLocationsRequest($arguments);
    ...
    /**
     * Operation routeStoreGeoLocationsAsync
     *
     * Store tracked Geo Locations in bulk
     *
     * @param  \BumbalClient\Model\RouteStoreGeoLocations $arguments Request Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function routeStoreGeoLocationsAsync($arguments)
    {
        return $this->routeStoreGeoLocationsAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation routeStoreGeoLocationsAsyncWithHttpInfo
     *
     * Store tracked Geo Locations in bulk
     *
     * @param  \BumbalClient\Model\RouteStoreGeoLocations $arguments Request Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function routeStoreGeoLocationsAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->routeStoreGeoLocationsRequest($arguments);
    ...
    /**
     * Create request for operation 'routeStoreGeoLocations'
     *
     * @param  \BumbalClient\Model\RouteStoreGeoLocations $arguments Request Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function routeStoreGeoLocationsRequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling routeStoreGeoLocations'
            );
        }
     ...
     * @return \BumbalClient\Model\ApiResponse
     */
    public function unblockRoutes($filters)
    {
        list($response) = $this->unblockRoutesWithHttpInfo($filters);
        return $response;
    }

    /**
     * Operation unblockRoutesWithHttpInfo
     *
     * Unblock routes which satisfy set filters
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     ...
     * @return array of \BumbalClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function unblockRoutesWithHttpInfo($filters)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->unblockRoutesRequest($filters);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unblockRoutesAsync($filters)
    {
        return $this->unblockRoutesAsyncWithHttpInfo($filters)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation unblockRoutesAsyncWithHttpInfo
     *
     * Unblock routes which satisfy set filters
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unblockRoutesAsyncWithHttpInfo($filters)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->unblockRoutesRequest($filters);
    ...
    /**
     * Create request for operation 'unblockRoutes'
     *
     * @param  \BumbalClient\Model\RouteFiltersModel $filters Request Filters (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unblockRoutesRequest($filters)
    {
        // verify the required parameter 'filters' is set
        if ($filters === null || (is_array($filters) && count($filters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $filters when calling unblockRoutes'
            );
        }

        $resourcePath = '/route/unblock-routes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
