...
class TrackTraceApi
{
    ...
    public function trackTraceAttachActivityToIdentifierWithHttpInfo($body)
    {
        ...
        $request = $this->trackTraceAttachActivityToIdentifierRequest($body);
    ...
    /**
     * Operation trackTraceAttachActivityToIdentifierAsync
     *
     * Attach an activity to an identifier
     *
     * @param  \BumbalClient\Model\ActivityIdentifierModel $body Identifier activity model (required)
     ...
     */
    public function trackTraceAttachActivityToIdentifierAsync($body)
    {
        return $this->trackTraceAttachActivityToIdentifierAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation trackTraceAttachActivityToIdentifierAsyncWithHttpInfo
     *
     * Attach an activity to an identifier
     *
     * @param  \BumbalClient\Model\ActivityIdentifierModel $body Identifier activity model (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackTraceAttachActivityToIdentifierAsyncWithHttpInfo($body)
    {
        $returnType = '\BumbalClient\Model\ApiResponse';
        $request = $this->trackTraceAttachActivityToIdentifierRequest($body);
    ...
    /**
     * Create request for operation 'trackTraceAttachActivityToIdentifier'
     *
     * @param  \BumbalClient\Model\ActivityIdentifierModel $body Identifier activity model (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function trackTraceAttachActivityToIdentifierRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling trackTraceAttachActivityToIdentifier'
            );
        }
    ...
    {
        $returnType = '\BumbalClient\Model\RoutesEtaResponse';
        $request = $this->trackTraceCalculateRoutesETARequest($arguments);
    ...
    /**
     * Operation trackTraceCalculateRoutesETAAsync
     *
     * Calculate ETA for Activities on Routes
     *
     * @param  \BumbalClient\Model\RoutesEtaArguments $arguments Routes ETA Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackTraceCalculateRoutesETAAsync($arguments)
    {
        return $this->trackTraceCalculateRoutesETAAsyncWithHttpInfo($arguments)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation trackTraceCalculateRoutesETAAsyncWithHttpInfo
     *
     * Calculate ETA for Activities on Routes
     *
     * @param  \BumbalClient\Model\RoutesEtaArguments $arguments Routes ETA Arguments (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function trackTraceCalculateRoutesETAAsyncWithHttpInfo($arguments)
    {
        $returnType = '\BumbalClient\Model\RoutesEtaResponse';
        $request = $this->trackTraceCalculateRoutesETARequest($arguments);
    ...
    /**
     * Create request for operation 'trackTraceCalculateRoutesETA'
     *
     * @param  \BumbalClient\Model\RoutesEtaArguments $arguments Routes ETA Arguments (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function trackTraceCalculateRoutesETARequest($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null || (is_array($arguments) && count($arguments) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $arguments when calling trackTraceCalculateRoutesETA'
            );
        }
