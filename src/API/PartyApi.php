...
class PartyApi
{
    ...
    {
        $returnType = '\BumbalClient\Model\PartyListResponse';
    ...
    {
        $returnType = '\BumbalClient\Model\PartyModel';
        $request = $this->retrievePartyRequest($party_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePartyAsync($party_id)
    {
        return $this->retrievePartyAsyncWithHttpInfo($party_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePartyAsyncWithHttpInfo($party_id)
    {
        $returnType = '\BumbalClient\Model\PartyModel';
        $request = $this->retrievePartyRequest($party_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrievePartyRequest($party_id)
    {
        // verify the required parameter 'party_id' is set
        if ($party_id === null || (is_array($party_id) && count($party_id) === 0)) {
            throw new \InvalidArgumentException(
