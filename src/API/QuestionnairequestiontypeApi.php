...
class QuestionnairequestiontypeApi
{
    ...
    public function retrieveQuestionnaireQuestionTypeWithHttpInfo($questionnaire_question_type_id)
    {
        ...
        if ($questionnaire_question_type_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $questionnaire_question_type_id when calling retrieveQuestionnaireQuestionType');
        }
        // parse inputs
        ...
        if ($questionnaire_question_type_id !== null) {
            $resourcePath = str_replace(
                ...
                $this->apiClient->getSerializer()->toPathValue($questionnaire_question_type_id),
                $resourcePath
            );
        }
