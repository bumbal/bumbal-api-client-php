...
class SettingsModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSettingsGroupNameAllowableValues();
        if (!is_null($this->container['settings_group_name']) && !in_array($this->container['settings_group_name'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getSettingsGroupNameAllowableValues();
        if (!is_null($settings_group_name) && !in_array($settings_group_name, $allowedValues, true)) {
     ...
     * Sets value_options
     *
     * @param \BumbalClient\Model\ValueOptionModel[] $value_options value_options
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\UsersModel $setting_updated_by_user setting_updated_by_user
     *
     * @return $this
     */
