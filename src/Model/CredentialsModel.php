 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CredentialsModel implements ModelInterface, ArrayAccess
{
     ...
     * Sets client_id
     *
     * @param string $client_id Client ID for OAuth client credentials flow
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret Client Secret for OAuth client credentials flow
     *
     * @return $this
     */
