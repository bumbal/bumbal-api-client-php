 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LogModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getLevelTextAllowableValues();
        if (!is_null($this->container['level_text']) && !in_array($this->container['level_text'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getLevelTextAllowableValues();
        if (!is_null($level_text) && !in_array($level_text, $allowedValues, true)) {
