...
class ActivityModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'shipment_inbound_activity_ids' => 'int[]',
        'shipment_outbound_activity_ids' => 'int[]',
        ...
        'shipment_inbound_shipment_address_ids' => 'int[]',
        'shipment_outbound_shipment_address_ids' => 'int[]',
        'depot_activity' => '\BumbalClient\Model\ActivityModel',
        'depot_activities' => '\BumbalClient\Model\ActivityModel[]',
    ...
    protected static $swaggerFormats = [
        ...
        'shipment_inbound_activity_ids' => null,
        'shipment_outbound_activity_ids' => null,
        ...
        'shipment_inbound_shipment_address_ids' => null,
        'shipment_outbound_shipment_address_ids' => null,
        'depot_activity' => null,
        'depot_activities' => null,
        'action_type_id' => null,
    ...
    protected static $attributeMap = [
        ...
        'shipment_inbound_activity_ids' => 'shipment_inbound_activity_ids',
        'shipment_outbound_activity_ids' => 'shipment_outbound_activity_ids',
        ...
        'shipment_inbound_shipment_address_ids' => 'shipment_inbound_shipment_address_ids',
        'shipment_outbound_shipment_address_ids' => 'shipment_outbound_shipment_address_ids',
        'depot_activity' => 'depot_activity',
        'depot_activities' => 'depot_activities',
    ...
    protected static $setters = [
        ...
        'shipment_inbound_activity_ids' => 'setShipmentInboundActivityIds',
        'shipment_outbound_activity_ids' => 'setShipmentOutboundActivityIds',
        ...
        'shipment_inbound_shipment_address_ids' => 'setShipmentInboundShipmentAddressIds',
        'shipment_outbound_shipment_address_ids' => 'setShipmentOutboundShipmentAddressIds',
        'depot_activity' => 'setDepotActivity',
        'depot_activities' => 'setDepotActivities',
    ...
    protected static $getters = [
        ...
        'shipment_inbound_activity_ids' => 'getShipmentInboundActivityIds',
        'shipment_outbound_activity_ids' => 'getShipmentOutboundActivityIds',
        ...
        'shipment_inbound_shipment_address_ids' => 'getShipmentInboundShipmentAddressIds',
        'shipment_outbound_shipment_address_ids' => 'getShipmentOutboundShipmentAddressIds',
        'depot_activity' => 'getDepotActivity',
        'depot_activities' => 'getDepotActivities',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['shipment_inbound_activity_ids'] = isset($data['shipment_inbound_activity_ids']) ? $data['shipment_inbound_activity_ids'] : null;
        $this->container['shipment_outbound_activity_ids'] = isset($data['shipment_outbound_activity_ids']) ? $data['shipment_outbound_activity_ids'] : null;
        ...
        $this->container['shipment_inbound_shipment_address_ids'] = isset($data['shipment_inbound_shipment_address_ids']) ? $data['shipment_inbound_shipment_address_ids'] : null;
        $this->container['shipment_outbound_shipment_address_ids'] = isset($data['shipment_outbound_shipment_address_ids']) ? $data['shipment_outbound_shipment_address_ids'] : null;
        $this->container['depot_activity'] = isset($data['depot_activity']) ? $data['depot_activity'] : null;
        $this->container['depot_activities'] = isset($data['depot_activities']) ? $data['depot_activities'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['activity_type_name']) && !in_array($this->container['activity_type_name'], $allowedValues, true)) {
        ...
        $allowedValues = $this->getActivityTypeIdAllowableValues();
        if (!is_null($this->container['activity_type_id']) && !in_array($this->container['activity_type_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        if (!is_null($this->container['status_name']) && !in_array($this->container['status_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getActionTypeIdAllowableValues();
        if (!is_null($this->container['action_type_id']) && !in_array($this->container['action_type_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    /**
     * Gets shipment_inbound_activity_ids
     *
     * @return int[]
     */
    public function getShipmentInboundActivityIds()
    {
        return $this->container['shipment_inbound_activity_ids'];
    }

    /**
     * Sets shipment_inbound_activity_ids
     *
     * @param int[] $shipment_inbound_activity_ids Unique identifiers for connected shipment inbound activities
     *
     * @return $this
     */
    public function setShipmentInboundActivityIds($shipment_inbound_activity_ids)
    {
        $this->container['shipment_inbound_activity_ids'] = $shipment_inbound_activity_ids;

        return $this;
    }

    /**
     * Gets shipment_outbound_activity_ids
     *
     * @return int[]
     */
    public function getShipmentOutboundActivityIds()
    {
        return $this->container['shipment_outbound_activity_ids'];
    }

    /**
     * Sets shipment_outbound_activity_ids
     *
     * @param int[] $shipment_outbound_activity_ids Unique identifiers for connected shipment outbound activities
     *
     * @return $this
     */
    public function setShipmentOutboundActivityIds($shipment_outbound_activity_ids)
    {
        $this->container['shipment_outbound_activity_ids'] = $shipment_outbound_activity_ids;
    ...
    {
        $allowedValues = $this->getActivityTypeNameAllowableValues();
        if (!is_null($activity_type_name) && !in_array($activity_type_name, $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getActivityTypeIdAllowableValues();
        if (!is_null($activity_type_id) && !in_array($activity_type_id, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'activity_type_id', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getStatusNameAllowableValues();
        if (!is_null($status_name) && !in_array($status_name, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'status_name', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets assignment
     *
     * @param \BumbalClient\Model\AssignmentModel $assignment assignment
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|string|null $earliest_delivery_date_time earliest_delivery_date_time
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|string|null $latest_delivery_date_time latest_delivery_date_time
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|string|null $earliest_delivery_date earliest_delivery_date
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime|string|null $latest_delivery_date latest_delivery_date
     *
     * @return $this
     */
     ...
     * Sets address
     *
     * @param \BumbalClient\Model\AddressModel $address address
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\AddressAppliedModel $address_applied address_applied
     *
     * @return $this
     */
     ...
     * Sets depot_address
     *
     * @param \BumbalClient\Model\AddressModel $depot_address depot_address
     *
     * @return $this
     */
    ...
    /**
     * Gets shipment_inbound_shipment_address_ids
     *
     * @return int[]
     */
    public function getShipmentInboundShipmentAddressIds()
    {
        return $this->container['shipment_inbound_shipment_address_ids'];
    }

    /**
     * Sets shipment_inbound_shipment_address_ids
     *
     * @param int[] $shipment_inbound_shipment_address_ids Unique identifiers for connected shipment inbound addresses
     *
     * @return $this
     */
    public function setShipmentInboundShipmentAddressIds($shipment_inbound_shipment_address_ids)
    {
        $this->container['shipment_inbound_shipment_address_ids'] = $shipment_inbound_shipment_address_ids;

        return $this;
    }

    /**
     * Gets shipment_outbound_shipment_address_ids
     *
     * @return int[]
     */
    public function getShipmentOutboundShipmentAddressIds()
    {
        return $this->container['shipment_outbound_shipment_address_ids'];
    }

    /**
     * Sets shipment_outbound_shipment_address_ids
     *
     * @param int[] $shipment_outbound_shipment_address_ids Unique identifiers for connected shipment outbound addresses
     *
     * @return $this
     */
    public function setShipmentOutboundShipmentAddressIds($shipment_outbound_shipment_address_ids)
    {
        $this->container['shipment_outbound_shipment_address_ids'] = $shipment_outbound_shipment_address_ids;
     ...
     * Sets depot_activity
     *
     * @param \BumbalClient\Model\ActivityModel $depot_activity depot_activity
     *
     * @return $this
     */
    ...
    /**
     * Gets depot_activities
     *
     * @return \BumbalClient\Model\ActivityModel[]
     */
    public function getDepotActivities()
    {
        return $this->container['depot_activities'];
    }

    /**
     * Sets depot_activities
     *
     * @param \BumbalClient\Model\ActivityModel[] $depot_activities depot_activities
     *
     * @return $this
     */
    public function setDepotActivities($depot_activities)
    {
        $this->container['depot_activities'] = $depot_activities;
    ...
    {
        $allowedValues = $this->getActionTypeIdAllowableValues();
        if (!is_null($action_type_id) && !in_array($action_type_id, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'action_type_id', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param \BumbalClient\Model\AllowedDriverModel[] $allowed_drivers allowed_drivers
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\LinkModel[] $allowed_drivers_links allowed_drivers_links
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\AppliedCapacitiesModel $applied_capacities applied_capacities
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\RouteCapacitiesModel[] $route_capacities_before route_capacities_before
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\RouteCapacitiesModel[] $route_capacities_after route_capacities_after
     *
     * @return $this
     */
     ...
     * Sets capacities
     *
     * @param \BumbalClient\Model\CapacityModel[] $capacities capacities
     *
     * @return $this
     */
     ...
     * Sets package_lines
     *
     * @param \BumbalClient\Model\PackageLineModel[] $package_lines package_lines
     *
     * @return $this
     */
     ...
     * Sets recoveries
     *
     * @param \BumbalClient\Model\RecoveryModel[] $recoveries recoveries
     *
     * @return $this
     */
     ...
     * Sets payments
     *
     * @param \BumbalClient\Model\PaymentModel[] $payments payments
     *
     * @return $this
     */
     ...
     * Sets brand
     *
     * @param \BumbalClient\Model\BrandModel $brand brand
     *
     * @return $this
     */
     ...
     * Sets communication
     *
     * @param \BumbalClient\Model\CommunicationModel $communication communication
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\LinkModel $assignment_link assignment_link
     *
     * @return $this
     */
     ...
     * Sets route_link
     *
     * @param \BumbalClient\Model\LinkModel $route_link route_link
     *
     * @return $this
     */
     ...
     * Sets route
     *
     * @param \BumbalClient\Model\RouteModel $route route
     *
     * @return $this
     */
     ...
     * Sets driver
     *
     * @param \BumbalClient\Model\DriverModel $driver driver
     *
     * @return $this
     */
     ...
     * Sets driver_links
     *
     * @param \BumbalClient\Model\LinkModel[] $driver_links driver_links
     *
     * @return $this
     */
     ...
     * Sets car
     *
     * @param \BumbalClient\Model\VehicleModel $car car
     *
     * @return $this
     */
     ...
     * Sets vehicle
     *
     * @param \BumbalClient\Model\VehicleModel $vehicle vehicle
     *
     * @return $this
     */
     ...
     * Sets trailer
     *
     * @param \BumbalClient\Model\TrailerModel $trailer trailer
     *
     * @return $this
     */
     ...
     * Sets recurrence
     *
     * @param \BumbalClient\Model\RecurrenceServiceModel $recurrence recurrence
     *
     * @return $this
     */
     ...
     * Sets zones
     *
     * @param \BumbalClient\Model\ZoneModel[] $zones zones
     *
     * @return $this
     */
     ...
     * Sets stats
     *
     * @param \BumbalClient\Model\ActivityStatsModel $stats stats
     *
     * @return $this
     */
     ...
     * Sets notes
     *
     * @param \BumbalClient\Model\NoteModel[] $notes notes
     *
     * @return $this
     */
     ...
     * Sets irregularities
     *
     * @param \BumbalClient\Model\IrregularityModel[] $irregularities irregularities
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\UsersModel $activity_created_by_user activity_created_by_user
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\UsersModel $activity_updated_by_user activity_updated_by_user
     *
     * @return $this
     */
     ...
     * Sets transactions
     *
     * @param \BumbalClient\Model\TransactionModel[] $transactions transactions
     *
     * @return $this
     */
