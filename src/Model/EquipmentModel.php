...
class EquipmentModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getEquipmentTypeNameAllowableValues();
        if (!is_null($this->container['equipment_type_name']) && !in_array($this->container['equipment_type_name'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getEquipmentTypeNameAllowableValues();
        if (!is_null($equipment_type_name) && !in_array($equipment_type_name, $allowedValues, true)) {
