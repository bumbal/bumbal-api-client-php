...
class PackageLineModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['action_type_name']) && !in_array($this->container['action_type_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getCheckTypeIdAllowableValues();
        if (!is_null($this->container['check_type_id']) && !in_array($this->container['check_type_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getCheckTypeNameAllowableValues();
        if (!is_null($this->container['check_type_name']) && !in_array($this->container['check_type_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
     ...
     * Sets shipment_id
     *
     * @param int $shipment_id Unique Identifier for shipment activity where this packageline is related to
     *
     * @return $this
     */
     ...
     *
     * @param int $depot_address_id Unique Identifier for shipment address where this packageline is related to
     *
     * @return $this
     */
    ...
    /**
     * Gets depot_address_link
     *
     * @return \BumbalClient\Model\LinkModel
     */
    public function getDepotAddressLink()
    {
        return $this->container['depot_address_link'];
    }

    /**
     * Sets depot_address_link
     *
     * @param \BumbalClient\Model\LinkModel $depot_address_link link to the depot address connected to this package_line (only for create/updats actions)
     *
     * @return $this
     */
    public function setDepotAddressLink($depot_address_link)
    {
        $this->container['depot_address_link'] = $depot_address_link;
     ...
     * Sets barcodes
     *
     * @param string[] $barcodes For every barcode in this array, a separate packageline will be created
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getActionTypeNameAllowableValues();
        if (!is_null($action_type_name) && !in_array($action_type_name, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'action_type_name', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getCheckTypeIdAllowableValues();
        if (!is_null($check_type_id) && !in_array($check_type_id, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'check_type_id', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getCheckTypeNameAllowableValues();
        if (!is_null($check_type_name) && !in_array($check_type_name, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'check_type_name', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets compartments
     *
     * @param \BumbalClient\Model\CompartmentModel[] $compartments compartments
     *
     * @return $this
     */
     ...
     *
     * @param object $applied_capacities applied_capacities
     *
     * @return $this
     */
