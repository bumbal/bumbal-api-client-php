...
class PackageLineModel implements ArrayAccess
{
     ...
     * @param \DateTime|string|null|string|null|string|null $package_line_created_at created_at date time
     * @return $this
     */
     ...
     * @param \DateTime|string|null|string|null|string|null $package_line_updated_at updated_at date time
     * @return $this
     */
