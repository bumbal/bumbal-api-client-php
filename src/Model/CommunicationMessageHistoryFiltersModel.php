...
class CommunicationMessageHistoryFiltersModel implements ArrayAccess
{
    ...
    /**
     * Sets provider_name
     * @param string[] $provider_name Provider name for the history events
     * @return $this
     */
     ...
     * @param \DateTime|string|null|string|null|string|null|string|null|string|null $created_at_since Filter by communication message history created at since
     * @return $this
     */
