<?php
/**
 * ActivityBulkUpdateTagDataModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ActivityBulkUpdateTagDataModel Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActivityBulkUpdateTagDataModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ActivityBulkUpdateTagDataModel';
     ...
     * Sets tag_type_id
     *
     * @param int $tag_type_id The ID of the tag type to update the activities with
     *
     * @return $this
     */
     ...
     * Sets tag_type_name
     *
     * @param string $tag_type_name Optional alternative to tag_type_id - specify the name of the tag type instead of the ID. If both are provided, tag_type_id will be used.
     *
     * @return $this
     */
