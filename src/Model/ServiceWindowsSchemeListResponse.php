...
/**
 * ServiceWindowsSchemeListResponse Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ServiceWindowsSchemeListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServiceWindowsSchemeListResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\BumbalClient\Model\ServiceWindowsSchemeModel[]',
        'count_filtered' => 'int',
     ...
     * Sets items
     *
     * @param \BumbalClient\Model\ServiceWindowsSchemeModel[] $items items
     *
     * @return $this
     */
