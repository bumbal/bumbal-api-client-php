...
/**
 * CommunicationMessageListResponse Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationMessageListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationMessageListResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\BumbalClient\Model\CommunicationMessageModel[]',
        'count_filtered' => 'int',
     ...
     * Sets items
     *
     * @param \BumbalClient\Model\CommunicationMessageModel[] $items items
     *
     * @return $this
     */
