...
/**
 * ReportRetrieveListArguments Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReportRetrieveListArguments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReportRetrieveListArguments';
    ...
    protected static $swaggerTypes = [
        'options' => '\BumbalClient\Model\ReportOptionsModel',
        'filters' => '\BumbalClient\Model\ReportFiltersModel',
        'limit' => 'int',
        'offset' => 'int',
    ...
    const SORTING_COLUMN_FILE_NAME = 'file_name';
    const SORTING_COLUMN_CREATION_DATE = 'creation_date';
    ...
    public function getSortingColumnAllowableValues()
    {
        return [
            ...
            self::SORTING_COLUMN_FILE_NAME,
            self::SORTING_COLUMN_CREATION_DATE,
        ];
    }
     ...
     * Gets options
     *
     * @return \BumbalClient\Model\ReportOptionsModel
     */
     ...
     * Sets options
     *
     * @param \BumbalClient\Model\ReportOptionsModel $options options
     *
     * @return $this
     */
     ...
     * Gets filters
     *
     * @return \BumbalClient\Model\ReportFiltersModel
     */
     ...
     * Sets filters
     *
     * @param \BumbalClient\Model\ReportFiltersModel $filters filters
     *
     * @return $this
     */
