...
class CommunicationModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['saywhen_status_name']) && !in_array($this->container['saywhen_status_name'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getSaywhenStatusNameAllowableValues();
        if (!is_null($saywhen_status_name) && !in_array($saywhen_status_name, $allowedValues, true)) {
