 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActivityBulkUpdateTimeSlotDataModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTimeSlotTypeAllowableValues();
        if (!is_null($this->container['time_slot_type']) && !in_array($this->container['time_slot_type'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getTimeSlotTypeAllowableValues();
        if (!is_null($time_slot_type) && !in_array($time_slot_type, $allowedValues, true)) {
