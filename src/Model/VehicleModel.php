...
class VehicleModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getVehicleTypeNameAllowableValues();
        if (!is_null($this->container['vehicle_type_name']) && !in_array($this->container['vehicle_type_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getVehicleTypeNameAllowableValues();
        if (!is_null($vehicle_type_name) && !in_array($vehicle_type_name, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'vehicle_type_name', must be one of '%s'",
                    implode("', '", $allowedValues)
