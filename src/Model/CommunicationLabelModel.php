...
/**
 * CommunicationLabelModel Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationLabelModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationLabelModel';
     ...
     * Sets name
     *
     * @param string $name Communication Label Name
     *
     * @return $this
     */
