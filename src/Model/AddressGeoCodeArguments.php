 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressGeoCodeArguments implements ModelInterface, ArrayAccess
{
    ...
    {
        $allowedValues = $this->getExcludeProvidersAllowableValues();
        if (!is_null($exclude_providers) && array_diff($exclude_providers, $allowedValues)) {
