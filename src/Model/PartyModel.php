...
class PartyModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['party_type_name']) && !in_array($this->container['party_type_name'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getPartyTypeNameAllowableValues();
        if (!is_null($party_type_name) && !in_array($party_type_name, $allowedValues, true)) {
     ...
     *
     * @param \BumbalClient\Model\UsersModel $party_created_by_user party_created_by_user
     *
     * @return $this
     */
     ...
     *
     * @param \BumbalClient\Model\UsersModel $party_updated_by_user party_updated_by_user
     *
     * @return $this
     */
