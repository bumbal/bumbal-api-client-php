...
/**
 * CommunicationMessageTypeListResponse Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationMessageTypeListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationMessageTypeListResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\BumbalClient\Model\CommunicationMessageTypeModel[]',
        'count_filtered' => 'int',
     ...
     * Sets items
     *
     * @param \BumbalClient\Model\CommunicationMessageTypeModel[] $items items
     *
     * @return $this
     */
