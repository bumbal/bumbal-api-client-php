...
class TimeSlotModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTimeSlotTypeIdAllowableValues();
        if (!is_null($this->container['time_slot_type_id']) && !in_array($this->container['time_slot_type_id'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getTimeSlotTypeIdAllowableValues();
        if (!is_null($time_slot_type_id) && !in_array($time_slot_type_id, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'time_slot_type_id', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets date_from
     *
     * @param \DateTime|string|null $date_from date_from
     *
     * @return $this
     */
     ...
     * Sets date_time_from
     *
     * @param \DateTime|string|null $date_time_from date_time_from
     *
     * @return $this
     */
     ...
     * Sets date_to
     *
     * @param \DateTime|string|null $date_to date_to
     *
     * @return $this
     */
     ...
     * Sets date_time_to
     *
     * @param \DateTime|string|null $date_time_to date_time_to
     *
     * @return $this
     */
