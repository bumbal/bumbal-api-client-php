 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FilledCapacityModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getUomNameAllowableValues();
        if (!is_null($this->container['uom_name']) && !in_array($this->container['uom_name'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getUomNameAllowableValues();
        if (!is_null($uom_name) && !in_array($uom_name, $allowedValues, true)) {
