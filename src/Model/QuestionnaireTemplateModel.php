...
class QuestionnaireTemplateModel implements ArrayAccess
{
    ...
    /**
     * Sets created_at
     * @param \DateTime|string|null|string|null|string|null|string|null|string|null $created_at Date and time when the questionnaire template was created
     * @return $this
     */
    ...
    /**
     * Sets updated_at
     * @param \DateTime|string|null|string|null|string|null|string|null|string|null $updated_at Date and time when the questionnaire template was last updated
     * @return $this
     */
