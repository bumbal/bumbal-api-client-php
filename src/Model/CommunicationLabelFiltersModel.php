...
/**
 * CommunicationLabelFiltersModel Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationLabelFiltersModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationLabelFiltersModel';
     ...
     * Sets id
     *
     * @param int[] $id CommunicationLabel's id
     *
     * @return $this
     */
