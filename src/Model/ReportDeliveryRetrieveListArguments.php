...
/**
 * ReportDeliveryRetrieveListArguments Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReportDeliveryRetrieveListArguments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReportDeliveryRetrieveListArguments';
    ...
    protected static $swaggerTypes = [
        'options' => '\BumbalClient\Model\ReportDeliveryOptionsModel',
        'filters' => '\BumbalClient\Model\ReportDeliveryFiltersModel',
        'limit' => 'int',
        'offset' => 'int',
    ...
    const SORTING_COLUMN_REPORT_ID = 'report_id';
    const SORTING_COLUMN_REPORT_NAME = 'report_name';
    const SORTING_COLUMN_EXPORT_TYPE = 'export_type';
    ...
    public function getSortingColumnAllowableValues()
    {
        return [
            ...
            self::SORTING_COLUMN_REPORT_ID,
            self::SORTING_COLUMN_REPORT_NAME,
            self::SORTING_COLUMN_EXPORT_TYPE,
        ];
    }
     ...
     * Gets options
     *
     * @return \BumbalClient\Model\ReportDeliveryOptionsModel
     */
     ...
     * Sets options
     *
     * @param \BumbalClient\Model\ReportDeliveryOptionsModel $options options
     *
     * @return $this
     */
     ...
     * Gets filters
     *
     * @return \BumbalClient\Model\ReportDeliveryFiltersModel
     */
     ...
     * Sets filters
     *
     * @param \BumbalClient\Model\ReportDeliveryFiltersModel $filters filters
     *
     * @return $this
     */
