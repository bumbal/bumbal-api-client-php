...
/**
 * IrregularityReasonListResponse Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IrregularityReasonListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IrregularityReasonListResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\BumbalClient\Model\IrregularityReasonModel[]',
        'count_filtered' => 'int',
     ...
     * Sets items
     *
     * @param \BumbalClient\Model\IrregularityReasonModel[] $items items
     *
     * @return $this
     */
