...
/**
 * RouteDetachFromRecurrenceArguments Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RouteDetachFromRecurrenceArguments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RouteDetachFromRecurrenceArguments';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recurrence_uuid'] === null) {
            $invalidProperties[] = "'recurrence_uuid' can't be null";
        }
