...
class RecurrenceModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTypeNameAllowableValues();
        if (!is_null($this->container['type_name']) && !in_array($this->container['type_name'], $allowedValues, true)) {
        ...
        $allowedValues = $this->getEndOptionAllowableValues();
        if (!is_null($this->container['end_option']) && !in_array($this->container['end_option'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getPeriodNameAllowableValues();
        if (!is_null($this->container['period_name']) && !in_array($this->container['period_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getMonthlyOptionAllowableValues();
        if (!is_null($this->container['monthly_option']) && !in_array($this->container['monthly_option'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getTypeNameAllowableValues();
        if (!is_null($type_name) && !in_array($type_name, $allowedValues, true)) {
     ...
     * Sets start_date
     *
     * @param \DateTime|string|null $start_date Start date
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|string|null $end_date End date
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEndOptionAllowableValues();
        if (!is_null($end_option) && !in_array($end_option, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'end_option', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getPeriodNameAllowableValues();
        if (!is_null($period_name) && !in_array($period_name, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'period_name', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets next_run
     *
     * @param \DateTime|string|null $next_run Next date on which a new recurrence will be added
     *
     * @return $this
     */
     ...
     * Sets last_run
     *
     * @param \DateTime|string|null $last_run Last date on which a new recurrence was added
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getMonthlyOptionAllowableValues();
        if (!is_null($monthly_option) && !in_array($monthly_option, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'monthly_option', must be one of '%s'",
                    implode("', '", $allowedValues)
