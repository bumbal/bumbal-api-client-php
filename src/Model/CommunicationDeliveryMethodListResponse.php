...
/**
 * CommunicationDeliveryMethodListResponse Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationDeliveryMethodListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationDeliveryMethodListResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\BumbalClient\Model\CommunicationDeliveryMethodModel[]',
        'count_filtered' => 'int',
     ...
     * Sets items
     *
     * @param \BumbalClient\Model\CommunicationDeliveryMethodModel[] $items items
     *
     * @return $this
     */
