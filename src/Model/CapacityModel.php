...
class CapacityModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['capacity_value_uom_name']) && !in_array($this->container['capacity_value_uom_name'], $allowedValues, true)) {
        ...
        if (!is_null($this->container['unit_values_uom_name']) && !in_array($this->container['unit_values_uom_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
     ...
     * Sets capacity_type
     *
     * @param \BumbalClient\Model\CapacityTypeModel $capacity_type capacity_type
     *
     * @return $this
     */
     ...
     * Sets unit_values
     *
     * @param \BumbalClient\Model\UnitValueModel[] $unit_values unit_values
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getCapacityValueUomNameAllowableValues();
        if (!is_null($capacity_value_uom_name) && !in_array($capacity_value_uom_name, $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getUnitValuesUomNameAllowableValues();
        if (!is_null($unit_values_uom_name) && !in_array($unit_values_uom_name, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'unit_values_uom_name', must be one of '%s'",
                    implode("', '", $allowedValues)
