...
class RouteFiltersModel implements ArrayAccess
{
     ...
     * @param \DateTime|string|null|string|null|string|null|string|null|string|null $created_at_since filter routes with an created at date-time since this input
     * @return $this
     */
     ...
     * @param \DateTime|string|null|string|null|string|null|string|null|string|null $created_at_till filter routes with an created at date-time till this input
     * @return $this
     */
