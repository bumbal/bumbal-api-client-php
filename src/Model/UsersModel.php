...
class UsersModel implements ModelInterface, ArrayAccess
{
    ...
    {
        $allowedValues = $this->getRoleNameAllowableValues();
        if (!is_null($role_name) && !in_array($role_name, $allowedValues, true)) {
     ...
     *
     * @param \BumbalClient\Model\DriverUnavailabilityModel[] $driver_unavailabilities driver_unavailabilities
     *
     * @return $this
     */
