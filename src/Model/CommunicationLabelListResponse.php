...
/**
 * CommunicationLabelListResponse Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationLabelListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationLabelListResponse';
    ...
    protected static $swaggerTypes = [
        'items' => '\BumbalClient\Model\CommunicationLabelModel[]',
        'count_filtered' => 'int',
     ...
     * Sets items
     *
     * @param \BumbalClient\Model\CommunicationLabelModel[] $items items
     *
     * @return $this
     */
