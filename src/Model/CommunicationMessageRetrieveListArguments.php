 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommunicationMessageRetrieveListArguments implements ModelInterface, ArrayAccess
{
    ...
    const SORTING_COLUMN_COMMUNICATION_MESSAGEID = 'communication_message.id';
    ...
    {
        return [
            self::SORTING_COLUMN_COMMUNICATION_MESSAGEID,
        ];
    }
     ...
     * Sets options
     *
     * @param \BumbalClient\Model\CommunicationMessageOptionsModel $options options
     *
     * @return $this
     */
     ...
     * Sets filters
     *
     * @param \BumbalClient\Model\CommunicationMessageFiltersModel $filters filters
     *
     * @return $this
     */
