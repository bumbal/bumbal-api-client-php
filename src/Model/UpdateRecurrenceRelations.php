...
/**
 * UpdateRecurrenceRelations Class Doc Comment
 *
 * @category Class
 * @package  BumbalClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateRecurrenceRelations implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateRecurrenceRelations';
     ...
     * Sets route_ids
     *
     * @param int[] $route_ids Route id's
     *
     * @return $this
     */
